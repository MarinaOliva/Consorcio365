      ...
      <div className="relative">
        <select
          ...
          className={`
            ...
            focus:outline-none 
            ${disabled
              ? "cursor-default border-slate-200 bg-slate-50 text-slate-600 pr-4"
              : "border-slate-300 bg-white pr-11 text-slate-800 focus:ring-2 focus:ring-purple-400/40"
            }
