...
function ModalDetalleHistorialTrabajoProveedor({
  isOpen,
  trabajo,
  onClose,
}) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start justify-center overflow-y-auto px-4 py-4 sm:items-center">
      <div
      ...
      <div
        role="dialog"
        aria-modal="true"
        aria-labelledby="detalle-historial-trabajo-title"
        className="
          relative z-10 my-auto flex w-full max-w-[800px]
      ...
      >
        ...
        <div className="flex items-center justify-between bg-secondary px-6 py-4 text-white">
          <h2 id="detalle-historial-trabajo-title" className="text-lg font-bold">
        ...
        <div className="flex-1 overflow-y-auto px-6 py-6">
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-x-5 gap-y-4 md:grid-cols-6">
              ...
              <ItemInfo label="Edificio" value={trabajo.edificio || trabajo.ubicacion || "Torre Norte"} />
              <ItemInfo label="Unidad" value={trabajo.unidad || "5B"} />
              <ItemInfo label="Presupuesto" value={formatearMonto(trabajo.monto || trabajo.presupuesto)} />
              <ItemInfo label="Fecha inicio" value={trabajo.fechaAsignacion || trabajo.fecha || "-"} />
            ...
            <div>
              ...
              <p className="mt-2 text-sm leading-relaxed text-textMain">
                {trabajo.descripcion ||
                  "Trabajo ejecutado por el proveedor y finalizado según el historial disponible."}
              </p>
            </div>
            ...
            <div>
              ...
              {evidencias.length > 0 ? (
                ...
                <p className="text-sm text-textMuted">
                  No hay evidencias cargadas para este trabajo.
                </p>
              )}
            </div>
          </div>
...
export default ModalDetalleHistorialTrabajoProveedor;