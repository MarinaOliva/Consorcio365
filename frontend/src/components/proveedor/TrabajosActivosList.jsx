import { Wrench, MapPin, Calendar, DollarSign, ArrowRight } from "lucide-react";
    	...
    	<div className="flex items-center gap-3 shrink-0">
      	...
      	<button
        	...
        	className="
          	...
          	px-3 py-1.5 text-xs font-semibold text-textMain
  ...
  return (
	<Card className="border-secondary/70 bg-white p-4 shadow-[3px_5px_8px_rgba(7,40,48,0.25)]">
  	...
  	<div className="space-y-2.5">
    	{trabajos.map((t) => (
      	<TrabajoRow key={t.id} trabajo={t} onVerDetalle={onVerDetalle} />
    	))}
  	</div>
	</Card>
  );
